                ...
                <div class="d-flex align-items-end row">
                    ...
                    <div class="col-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                            <img src="/assets/backend/img/illustrations/card-advance-sale.png" height="140"
                                alt="view sales">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3 text-center">
                                <small class="text-muted mt-3">$21k Expenses more than last
                                    month</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <ul class="p-0 m-0">
                        <li class="d-flex mb-6">
                            <div class="me-4">
                                <img src="/assets/backend/img/products/iphone.png" alt="User" class="rounded"
                                    width="46">
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex mb-6">
                            <div class="me-4">
                                <img src="/assets/backend/img/products/nike-air-jordan.png" alt="User"
                        ...
                        <li class="d-flex mb-6">
                            <div class="me-4">
                                <img src="/assets/backend/img/products/headphones.png" alt="User" class="rounded"
                                    width="46">
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex mb-6">
                            <div class="me-4">
                                <img src="/assets/backend/img/products/apple-watch.png" alt="User" class="rounded"
                                    width="46">
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex mb-6">
                            <div class="me-4">
                                <img src="/assets/backend/img/products/amazon-echo.png" alt="User" class="rounded"
                                    width="46">
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex">
                            <div class="me-4">
                                <img src="/assets/backend/img/products/play-station.png" alt="User" class="rounded"
                                    width="46">
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                                ...
                                <ul class="timeline mb-0">
                                    <li class="timeline-item ps-6 border-left-dashed">
                                        ...
                                        <div class="timeline-event ps-1">
                                            ...
                                            <p class="text-body mb-0">101 Boulder, California(CA),
                                                95959</p>
                                        </div>
                                    </li>
                                    <li class="timeline-item ps-6 border-transparent">
                                        ...
                                        <div class="timeline-event ps-1">
                                            ...
                                            <p class="text-body mb-0">939 Orange, California(CA),
                                                92118</p>
                                        </div>
                                    </li>
                                </ul>
                                <div class="border-1 border-light border-top border-dashed my-4">
                                </div>
                                <ul class="timeline mb-0">
                                    <li class="timeline-item ps-6 border-left-dashed">
                                        <span
                                        ...
                                        <div class="timeline-event ps-1">
                                            ...
                                            <p class="text-body mb-0">162 Windsor, California(CA),
                                                95492</p>
                                        </div>
                                    </li>
                                    <li class="timeline-item ps-6 border-transparent">
                                        ...
                                        <div class="timeline-event ps-1">
                                            ...
                                            <p class="text-body mb-0">487 Sunset, California(CA),
                                                94043</p>
                                        </div>
                                    </li>
                                </ul>
